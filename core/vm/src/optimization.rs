            ...
            if let Some((prev_dst, prev_src, prev_idx)) = skip_next_reverse {
                ...
                if prev_dst == curr_src && prev_src == curr_dst {
                    ...
                    for check_idx in (prev_idx + 1)..optimized.len() {
                        ...
                        if matches!(check_opcode, Opcode::Mov | Opcode::LoadK | Opcode::LoadName | 
                                   Opcode::InitName | Opcode::StoreName | Opcode::LoadI | Opcode::LoadArg |
                                   Opcode::AddI | Opcode::SubI | Opcode::MulI | Opcode::DivI | Opcode::Inc | Opcode::Dec) {
